...
function App() {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      text: "Your JD was auto-saved successfully.",
      time: "Just now",
      read: false,
    },
    {
    ...
    {
      id: 3,
      text: "New template: Senior Data Scientist available.",
      time: "1 hr ago",
      read: true,
    },
  ]);
                          ...
                          >
                            <div
                              style={{
                                ...
                                height: "8px",
                                borderRadius: "50%",
                                background: n.read ? "transparent" : "#E8510A",
                                marginTop: "5px",
                                flexShrink: 0,
                              }}
                            ></div>
